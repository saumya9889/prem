...
const Menu = ({}:MenuProps) => {
  ...
  return (
    ...
    >
      ...
      <List link="https://www.instagram.com/iam_prem_sharma/" effect="slideUp">
        <Video /> Videos
      </List> */}
      ...
      <List
        target="_blank"
        link="https://www.instagram.com/iam_prem_sharma/"
        effect="slideUp"
      >
        <Instagram color="#b5179e" /> Instagram
      </List>
      <List target="_blank" link="https://github.com/premsharma1230" effect="slideUp">
      ...
      <List
        target="_blank"
        link="https://www.linkedin.com/in/prem-vishwakarma-%F0%9F%87%AE%F0%9F%87%B3-483135169/"
        effect="slideUp"
      >
